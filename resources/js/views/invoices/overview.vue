        ...
        <b-row class="justify-content-center">
            <b-col xxl="9">
                <div class="hstack gap-2 justify-content-end d-print-none mb-4">
                    ...
                    <b-button type="button" id="download-button" variant="primary"><i
                            class="ri-download-2-line align-bottom me-1"></i> Download</b-button>
                </div>
                <b-card no-body class="overflow-hidden" id="invoice">
                    ...
                    <b-card-body class="z-1 position-relative">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <img :src="logoLight" class="card-logo" alt="logo light" height="28" />
                            </div>
                            <div class="flex-shrink-0 mt-sm-0 mt-3">
                                <h6><span class="text-muted fw-normal">Legal Registration No:</span> <span
                                        id="legal-register-no">32654 9851</span></h6>
                                <h6><span class="text-muted fw-normal">Email:</span> <span
                                        id="email">steex@themesbrand.com</span></h6>
                                <h6><span class="text-muted fw-normal">Website:</span> <b-link
                                        href="https://themesbrand.com/" class="link-primary" target="_blank"
                                        id="website">www.themesbrand.com</b-link></h6>
                        ...
                        <div class="mt-5 pt-4">
                            <b-row class="g-3">
                                ...
                                <b-col cols="6" class="col-lg">
                                    ...
                                    <span class="badge bg-success-subtle text-success fs-xxs"
                        ...
                        <div class="mt-4 pt-2">
                            <b-row class="g-3">
                                <b-col cols="6">
                                    ...
                                    <p class="text-muted mb-1" id="billing-address-line-1">6382 Cerromar Cir, Orangevale,
                                        California, US.</p>
                                    <p class="text-muted mb-1"><span>Phone: +</span><span id="billing-phone-no">(909) 594
                                            2812</span></p>
                                ...
                                <b-col cols="6">
                                    ...
                                    <p class="text-muted mb-1" id="shipping-address-line-1">505 W Cordova Rd, Santa Fe, New
                                        York, US</p>
                                    <p class="text-muted mb-1"><span>Phone: +</span><span id="shipping-phone-no">(505) 989
                                            1378</span></p>
                                </b-col>
                                <!--end col-->
                            </b-row>
                        ...
                        <div class="mt-3">
                            ...
                            <p class="text-muted mb-1">Card Holder: <span class="fw-medium" id="card-holder-name">Jennifer
                                    Mayert</span></p>
                            <p class="text-muted mb-1">Card Number: <span class="fw-medium" id="card-number">xxx xxxx xxxx
                                    1234</span></p>
                            <p class="text-muted mb-0">Total Amount: <span class="fw-medium">$</span><span
                                    id="card-total-amount">2,050.18</span></p>
                        </div>
                        <div class="mt-4 mb-4">
                            <b-alert variant="danger" class="mb-0" :model-value="true">
                        ...
                        <div>
                            <p class="mb-4 pb-2"><b>Congratulations on your recent purchase!</b> It has been our pleasure to
                                serve you, and we hope we see you again soon.</p>

                            <div class="invoice-signature text-center">
                                <img :src="signature" alt="" id="sign-img" height="30" />
