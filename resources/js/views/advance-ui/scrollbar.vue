                ...
                <b-col xl="6">
                    <b-card no-body>
                        ...
                        <b-card-body>
                            ...
                            <div class="mx-n3">
                                <SimpleBar data-simplebar data-simplebar-auto-hide="false" style="max-height: 220px;" class="px-3">
                                    <p>If several languages coalesce, the grammar of the resulting language is more simple and regular than that of the individual languages. The new common language will be more simple and regular than the existing</p>
                                    <p>To an English person, it will seem like simplified English, as a skeptical Cambridge friend of mine told me what Occidental is. The European languages are members of the same family. Their separate existence is a myth. For science, music, sport, etc, Europe uses the same vocabulary.</p>
                                    <p>The languages only differ in their grammar, their pronunciation and their most common words. Everyone realizes why a new common language would be desirable: one could refuse to pay expensive translators. To achieve this, it would be necessary to have uniform grammar, pronunciation and more common words.</p>
                        ...
                        <b-col xl="4" lg="6">
                            <b-card no-body>
                                ...
                                <b-card-body>
                                    ...
                                    <div class="mx-n3">
                                        <SimpleBar data-simplebar data-simplebar-auto-hide="false" data-simplebar-track="primary" style="max-height: 275px;">
                                            ...
                                            <b-link href="#!" class="text-reset notification-item d-block dropdown-item active">
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 avatar-xs me-3">
                                            ...
                                            <div class="text-center my-2">
                                                <b-link href="#" class="text-success"><i class="mdi mdi-loading mdi-spin fs-3xl align-middle me-2"></i> Load more </b-link>
                                            </div>
                                        </SimpleBar>
                                    </div>
                                </b-card-body>
                        ...
                        <b-col xl="4" lg="6">
                            <b-card no-body>
                                ...
                                <b-card-body>
                                    ...
                                    <div class="mx-n3">
                                        <SimpleBar data-simplebar data-simplebar-auto-hide="false" data-simplebar-track="secondary" style="max-height: 274px;">
                        ...
                        <b-col xl="4" lg="6">
                            <b-card no-body>
                                ...
                                <b-card-body>
                                    ...
                                    <div class="mx-n3">
                                        <SimpleBar data-simplebar data-simplebar-auto-hide="false" data-simplebar-track="success" style="max-height: 274px;">
                        ...
                        <b-col xl="4" lg="6">
                            <b-card no-body>
                                ...
                                <b-card-body>
                                    ...
                                    <div class="mx-n3">
                                        <SimpleBar data-simplebar data-simplebar-auto-hide="false" data-simplebar-track="info" style="max-height: 238px;">
                        ...
                        <b-col xl="4" lg="6">
                            <b-card no-body>
                                ...
                                <b-card-body>
                                    ...
                                    <div class="mx-n3">
                                        <SimpleBar data-simplebar data-simplebar-auto-hide="false" data-simplebar-track="warning" style="max-height: 220px;" class="px-3">
                                            <div class="d-flex align-items-center py-3">
                                                ...
                                                <div class="flex-shrink-0 ms-2">
                                                    <b-button type="button" size="sm" variant="outline-success"><i class="ri-user-add-line align-middle"></i></b-button>
                                                </div>
                                            </div>
                        ...
                        <b-col xl="4" lg="6">
                            <b-card no-body>
                                ...
                                <b-card-body>
                                    ...
                                    <div class="mx-n3">
                                        <SimpleBar data-simplebar data-simplebar-auto-hide="false" data-simplebar-track="danger" style="max-height: 220px;" class="px-3">
                        ...
                        <b-col xl="4" lg="6">
                            <b-card no-body>
                                ...
                                <b-card-body>
                                    ...
                                    <div class="mx-n3">
                                        <SimpleBar data-simplebar data-simplebar-auto-hide="false" data-simplebar-track="dark" style="max-height: 220px;">
                                            <ul class="list-group list-group-flush">
                                                            ...
                                                            <div class="flex-shrink-0">
                                                                <div class="hstack gap-3">
                                                                    <div data-bs-toggle="tooltip" data-bs-placement="top" title="Like">
                                                                        <b-link href="#" class="text-muted"><i class="ri-thumb-up-line"></i></b-link>
                                                                    </div>
                                                                    <div class="vr"></div>
                                                                    <div data-bs-toggle="tooltip" data-bs-placement="top" title="Comment">
                                                                        <b-link href="#" class="text-muted"><i class="ri-discuss-line"></i></b-link>
                                                                    </div>
                                                                    <div class="vr"></div>
