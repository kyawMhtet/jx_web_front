...
export default {
    ...
    methods: {
        ...
        async getItem() {
            ...
            try {
                const res = await axios.get(`http://localhost:8000/api/shop/products/${this.route.params.id}`);
                // console.log(res.data);
                this.item = res.data;
                this.scrollToTop();
                console.log(this.item);
            } catch (error) {
                console.log('fetching item detail : ' + error);
            }
        },
                        ...
                        <b-col xxl="8">
                            <b-card no-body class="rounded-end-0">
                                <b-card-body class="p-4">
                                    ...
                                    <h4 class="text-capitalize mb-3">{{ item?.sub_item_name }}</h4>
