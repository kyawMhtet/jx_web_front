...
<template>
    <Layout>
        ...
        <b-row>
            <b-col xxl="6">
                ...
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Headings</b-card-title>
                    </b-card-header>
    ...
    <code>&lt;h6 class=&quot;mb-1&quot;&gt;h6. Bootstrap heading &lt;small class=&quot;text-muted&quot;&gt;Semibold 0.8125rem (13px)&lt;/small&gt;&lt;/h6&gt;</code></pre>
            ...
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Display Headings</b-card-title>
                    </b-card-header>
    ...
    <code>&lt;h1 class=&quot;display-6&quot;&gt;Display 6&lt;/h1&gt;</code></pre>
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Blockquotes</b-card-title>
                    </b-card-header>
    ...
    <code>
        &lt;blockquote class=&quot;blockquote blockquote-reverse fs-md&quot;&gt;
            &lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.&lt;/p&gt;
            &lt;footer class=&quot;blockquote-footer mt-0&quot;&gt;Someone famous in &lt;cite title=&quot;Source Title&quot;&gt;Source Title&lt;/cite&gt;&lt;/footer&gt;
        &lt;/blockquote&gt;</code></pre>
                    </b-card-body>
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Blockquote Background Color</b-card-title>
                    </b-card-header>
    ...
    <code>  
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Blockquote Border Color</b-card-title>
                    </b-card-header>
                    <b-card-body>
    ...
    <code>
        ...
        <b-row>
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Inline Text Elements</b-card-title>
                    </b-card-header>
                    ...
                    <b-card-body>
    <pre class="language-markup" style="height: 315px;"><code>
    &lt;p class=&quot;lead&quot;&gt;Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.&lt;/p&gt;</code>
    ...
    <code>&lt;p&gt;&lt;em&gt;This line rendered as italicized text.&lt;/em&gt;&lt;/p&gt;</code></pre>
            ...
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Unstyled List</b-card-title>
                    </b-card-header>
...
&lt;/ul&gt;</code></pre>
                ...
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Inline List</b-card-title>
                    </b-card-header>
    ...
    &lt;/ul&gt;</code></pre>
        ...
        <b-row>
            <b-col xl="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Description List Alignment</b-card-title>
                    </b-card-header>
                    ...
                    <b-card-body>
    <pre class="language-markup" style="height: 240px;"><code>
    &lt;dl class=&quot;row mb-0&quot;&gt;
        &lt;dt class=&quot;col-sm-3&quot;&gt;Description lists&lt;/dt&gt;
        &lt;dd class=&quot;col-sm-9&quot;&gt;A description list is perfect for defining terms.&lt;/dd&gt;
    ...
    &lt;/dl&gt;</code></pre>
        ...
        <b-row>
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Text Wrapping and Overflow</b-card-title>
                    </b-card-header>
    ...
    &lt;/div&gt;</code></pre>
                ...
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Word Break</b-card-title>
                    </b-card-header>
                    ...
                    <b-card-body>
                        <pre class="language-markup">
    <code>
&lt;p class=&quot;text-break mb-0&quot;&gt;mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm&lt;/p&gt;</code></pre>
                    </b-card-body>
                </b-card>
            </b-col>
            ...
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Font size</b-card-title>
                    </b-card-header>
    ...
    <code>&lt;p class=&quot;fs-6&quot;&gt;.fs-6 text&lt;/p&gt;</code></pre>
        ...
        <b-row>
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Font weight and italics</b-card-title>
                    </b-card-header>
                    ...
                    <b-card-body>
    <pre class="language-markup" style="height: 90px;"><code>
    &lt;p class=&quot;fw-bold&quot;&gt;Bold text.&lt;/p&gt;</code>
    ...
    <code>&lt;p class=&quot;fst-normal mb-0&quot;&gt;Text with normal font style&lt;/p&gt;</code></pre>
            ...
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Line height</b-card-title>
                    </b-card-header>
                    ...
                    <b-card-body>
    <pre class="language-markup" style="height: 160px;"><code>
    &lt;p class=&quot;lh-1&quot;&gt;This is a long paragraph written to show how the line-height of an element is affected by our utilities. Classes are applied to the element itself or sometimes the parent element. These classes can be customized as needed with our utility API.&lt;/p&gt;</code>
    ...
    <code>&lt;p class=&quot;lh-lg mb-0&quot;&gt;This is a long paragraph written to show how the line-height of an element is affected by our utilities. Classes are applied to the element itself or sometimes the parent element.&lt;/p&gt;</code></pre>
        ...
        <b-row>
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Text Transform</b-card-title>
                    </b-card-header>
                    ...
                    <b-card-body>
                        <pre class="language-markup" style="height: 118px;"><code>
    ...
    <code>&lt;p class=&quot;text-capitalize mb-0&quot;&gt;CapiTaliZed text.&lt;/p&gt;</code></pre>
            ...
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Text Decoration</b-card-title>
                    </b-card-header>
                    ...
                    <b-card-body>
                        <pre class="language-markup"><code>
    &lt;p class=&quot;text-decoration-underline&quot;&gt;This text has a line underneath it.&lt;/p&gt;</code>

    <code>&lt;p class=&quot;text-decoration-line-through&quot;&gt;This text has a line going through it.&lt;/p&gt;</code>

    <code>&lt;b-link href=&quot;#&quot; class=&quot;text-decoration-none&quot;&gt;This link has its text decoration removed&lt;/b-link&gt;</code></pre>
                    </b-card-body>
                </b-card>
            </b-col>
        ...
        <b-row>
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Text Truncation</b-card-title>
                    </b-card-header>
...
&lt;/span&gt;</code></pre>
            ...
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Visibility</b-card-title>
                    </b-card-header>
                    ...
                    <b-card-body>
    <pre class="language-markup" style="height: 105px;"><code>
    &lt;div class=&quot;visible&quot;&gt;text visible Lorem ipsum dolor sit amet&lt;/div&gt;</code>
    ...
    <code>&lt;div class=&quot;invisible&quot;&gt;text invisible Lorem ipsum dolor sit amet&lt;/div&gt;</code></pre>
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Clearfix</b-card-title>
                    </b-card-header>
                    ...
                    <b-card-body>
                        ...
                        <div class="bg-light clearfix p-3">
                            <b-button type="button" variant="secondary" class="float-start">Example Button floated left</b-button>
                            <b-button type="button" variant="success" class="float-end">Example Button floated right</b-button>
                        </div>
                    </b-card-body>
                    <b-card-body class="bg-light border-bottom border-top bg-opacity-25">
                        <h5 class="fs-xs text-muted mb-0">HTML Preview</h5>
    ...
    <pre class="language-markup"><code>&lt;div class=&quot;bg-light clearfix&quot;&gt;
        &lt;b-button type=&quot;button&quot; variant=&quot;secondary&quot; class=&quot;float-start&quot;&gt;Example Button floated left&lt;/b-button&gt;
        &lt;b-button type=&quot;button&quot; variant=&quot;secondary&quot; class=&quot;float-end&quot;&gt;Example Button floated right&lt;/b-button&gt;
&lt;/div&gt;</code></pre>
                    </b-card-body>
                </b-card>
            </b-col>
