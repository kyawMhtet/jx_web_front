    ...
    <Layout>
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Default Alerts</b-card-title>
                    </b-card-header>
...
&lt;/div&gt;
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Borderless Alerts</b-card-title>
                    </b-card-header>
...
&lt;/div&gt;
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Dismissing Alerts</b-card-title>
                    </b-card-header>
...
&lt;/div&gt;</code></pre>
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Link Color Alerts</b-card-title>
                    </b-card-header>

                    <b-card-body>
                        <p class="text-muted">Use the <code>alert-link</code> class at &lt;b-link&gt; tag to show matching
                        ...
                        <b-row>
                            <b-col xl="6">
                                <h6>Primary Alert</h6>
                                <div class="alert alert-primary" role="alert">
                                    A simple Primary alert with <b-link href="#" class="alert-link">an example
                                        link</b-link>. Give it a click if you like.
                                </div>

                                <h6>Secondary Alert</h6>
                                <div class="alert alert-secondary" role="alert">
                                    A simple Secondary alert with <b-link href="#" class="alert-link">an example
                                        link</b-link>. Give it a click if you like.
                                </div>

                                <h6>Success Alert</h6>
                                <div class="alert alert-success" role="alert">
                                    A simple Success alert with <b-link href="#" class="alert-link">an example
                                        link</b-link>. Give it a click if you like.
                                </div>

                                <h6>Danger Alert</h6>
                                <div class="alert alert-danger mb-xl-0" role="alert">
                                    A simple Danger alert with <b-link href="#" class="alert-link">an example
                                        link</b-link>. Give it a click if you like.
                                </div>
                            </b-col>
                            ...
                            <b-col xl="6">
                                <h6>Warning Alert</h6>
                                <div class="alert alert-warning" role="alert">
                                    A simple Warning alert with <b-link href="#" class="alert-link">an example
                                        link</b-link>. Give it a click if you like.
                                </div>

                                <h6>Info Alert</h6>
                                <div class="alert alert-info" role="alert">
                                    A simple Info alert with <b-link href="#" class="alert-link">an example
                                        link</b-link>. Give it a click if you like.
                                </div>

                                <h6>Light Alert</h6>
                                <div class="alert alert-light" role="alert">
                                    A simple Light alert with <b-link href="#" class="alert-link">an example
                                        link</b-link>. Give it a click if you like.
                                </div>

                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark mb-0" role="alert">
                                    A simple Dark alert with <b-link href="#" class="alert-link">an example
                                        link</b-link>. Give it a click if you like.
                                </div>
                            </b-col>
                        </b-row>
...
<code>&lt;!-- Primary Alert --&gt;
&lt;div class=&quot;alert alert-primary&quot; role=&quot;alert&quot;&gt;
    A simple &lt;b&gt;Primary alert&lt;/b&gt; with &lt;b-link href=&quot;#&quot; class=&quot;alert-link&quot;&gt;an example link&lt;/b-link&gt;. Give it a click if you like.
&lt;/div&gt;</code>

<code>&lt;!-- Secondary Alert --&gt;
&lt;div class=&quot;alert alert-secondary&quot; role=&quot;alert&quot;&gt;
    A simple &lt;b&gt;Secondary alert&lt;/b&gt; with &lt;b-link href=&quot;#&quot; class=&quot;alert-link&quot;&gt;an example link&lt;/b-link&gt;. Give it a click if you like.
&lt;/div&gt;</code>

<code>&lt;!-- Success Alert --&gt;
&lt;div class=&quot;alert alert-success&quot; role=&quot;alert&quot;&gt;
    A simple &lt;b&gt;Success alert&lt;/b&gt; with &lt;b-link href=&quot;#&quot; class=&quot;alert-link&quot;&gt;an example link&lt;/b-link&gt;. Give it a click if you like.
&lt;/div&gt;</code>

<code>&lt;!-- Danger Alert --&gt;
&lt;div class=&quot;alert alert-danger&quot; role=&quot;alert&quot;&gt;
    A simple &lt;b&gt;Danger alert&lt;/b&gt; with &lt;b-link href=&quot;#&quot; class=&quot;alert-link&quot;&gt;an example link&lt;/b-link&gt;. Give it a click if you like.
&lt;/div&gt;</code>

<code>&lt;!-- Warning Alert --&gt;
&lt;div class=&quot;alert alert-warning&quot; role=&quot;alert&quot;&gt;
    A simple &lt;b&gt;Warning alert&lt;/b&gt; with &lt;b-link href=&quot;#&quot; class=&quot;alert-link&quot;&gt;an example link&lt;/b-link&gt;. Give it a click if you like.
&lt;/div&gt;</code>

<code>&lt;!-- Info Alert --&gt;
&lt;div class=&quot;alert alert-info&quot; role=&quot;alert&quot;&gt;
    A simple &lt;b&gt;Info alert&lt;/b&gt; with &lt;b-link href=&quot;#&quot; class=&quot;alert-link&quot;&gt;an example link&lt;/b-link&gt;. Give it a click if you like.
&lt;/div&gt;</code>

<code>&lt;!-- Light Alert --&gt;
&lt;div class=&quot;alert alert-light&quot; role=&quot;alert&quot;&gt;
    A simple &lt;b&gt;Light alert&lt;/b&gt; with &lt;b-link href=&quot;#&quot; class=&quot;alert-link&quot;&gt;an example link&lt;/b-link&gt;. Give it a click if you like.
&lt;/div&gt;</code>

<code>&lt;!-- Dark Alert --&gt;
&lt;div class=&quot;alert alert-dark&quot; role=&quot;alert&quot;&gt;
    A simple &lt;b&gt;Dark alert&lt;/b&gt; with &lt;b-link href=&quot;#&quot; class=&quot;alert-link&quot;&gt;an example link&lt;/b-link&gt;. Give it a click if you like.
&lt;/div&gt;
</code></pre>
                    </b-card-body>
                </b-card>
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Live Alert Example</b-card-title>
                    </b-card-header>

                    <b-card-body>
                        <p class="text-muted">Click the Show live alert button to show an alert on button click.</p>
                        <div id="liveAlertPlaceholder">
                            <div class="alert alert-success alert-dismissible" :class="!liveAlert && 'd-none'" role="alert">Nice, you triggered this alert message!
                                <button type="button" class="btn-close" @click="liveAlert = !liveAlert"></button>
                            </div>
                        </div>
                        <b-button type="button" variant="primary" id="liveAlertBtn" @click="liveAlert = !liveAlert">Show
                            live alert</b-button>
                    </b-card-body>
                    <b-card-body class="bg-light border-bottom border-top bg-opacity-25">
                        <h5 class="fs-xs text-muted mb-0">HTML Preview</h5>
...
&lt;button type=&quot;button&quot; class=&quot;btn btn-primary&quot; id=&quot;liveAlertBtn&quot;&gt;Show live alert&lt;/button&gt;
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Outline Alerts</b-card-title>
                    </b-card-header>
                    ...
                    <b-card-body>
                        ...
                        <b-row>
                            ...
                            <b-col xl="6">
                                ...
                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark alert-dismissible bg-body-secondary fade show mb-0"
                                    role="alert">
...
&lt;/div&gt;
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Left Border Alerts</b-card-title>
                    </b-card-header>
                    <b-card-body>
...
&lt;/div&gt;
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Label Icon Alerts</b-card-title>
                    </b-card-header>
...
&lt;/div&gt;
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Additional Content Alerts</b-card-title>
                    </b-card-header>
...
&lt;/div&gt;</code></pre>
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Top Border with Outline Alerts</b-card-title>
                    </b-card-header>
...
&lt;/div&gt;
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Label Icon Arrow Alerts</b-card-title>
                    </b-card-header>
...
&lt;/div&gt;
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Rounded Label Icon Alerts</b-card-title>
                    </b-card-header>

                    <b-card-body>
                        <p class="text-muted">Use the <code>alert-label-icon rounded-label</code> class to set an alert with
                            a rounded label icon.</p>
                        <b-row>
                            <b-col xl="6">
                                <h6>Primary Alert</h6>
...
&lt;/div&gt;
    ...
    <b-row>
        <b-col lg="12">
            <b-card no-body>
                <b-card-header>
                    <b-card-title class="mb-0">Solid Alerts</b-card-title>
                </b-card-header>

                <b-card-body>
                    <p class="text-muted">Use the <code>border-*</code>, <code>bg-*</code>, <code>text-white</code>
                        class to set an alert with solid style.</p>
                    <b-row>
                        <b-col xl="6">
