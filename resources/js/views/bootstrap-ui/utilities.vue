...
export default {
    data() {
        return {
            ...
            avatar1, avatar2, avatar3, avatar4, avatar5, small2, small3, small6, 
        };
    },
    components: {
        Layout,
    ...
    <Layout>
                        ...
                        <div class="live-preview">
                            <div>
                                <div>
                                    <div class="d-flex align-items-start flex-wrap gap-4">
                                        <div class="text-center">
                                            <img :src="avatar2" class="avatar-md rounded"
                                                alt="rounded">
                                            <p><code>.rounded</code></p>
                                        </div>
                                        <div class="text-center">
                                            <img :src="avatar2" class="avatar-md rounded-top"
                                                alt="rounded-top">
                                            <p><code>.rounded-top</code></p>
                                        </div>
                                        <div class="text-center">
                                            <img :src="avatar2" class="avatar-md rounded-end"
                                                alt="rounded-end">
                                            <p><code>.rounded-end</code></p>
                                        </div>
                                        <div class="text-center">
                                            <img :src="avatar2" class="avatar-md rounded-bottom"
                                                alt="rounded-bottom">
                                            <p><code>.rounded-bottom</code></p>
                                        </div>
                                        <div class="text-center">
                                            <img :src="avatar2" class="avatar-md rounded-start"
                                                alt="rounded-start">
                                            <p><code>.rounded-start</code></p>
                                        </div>
                                        <div class="text-center">
                                            <img :src="avatar2" class="avatar-md rounded-circle"
                                                alt="rounded-circle">
                                        ...
                                        <div class="text-center">
                                            <img :src="small2" class="avatar-md w-auto rounded-pill"
                                                alt="rounded-pill">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex align-items-start flex-wrap gap-4">
                                        <div class="text-center">
                                            <img :src="avatar1" class="avatar-md rounded-0"
                                                alt="rounded-0">
                                            <p><code>.rounded-0</code></p>
                                        </div>
                                        <div class="text-center">
                                            <img :src="avatar1" class="avatar-md rounded-1"
                                                alt="rounded-1">
                                            <p><code>.rounded-1</code></p>
                                        </div>
                                        <div class="text-center">
                                            <img :src="avatar1" class="avatar-md rounded-2"
                                                alt="rounded-2">
                                            <p><code>.rounded-2</code></p>
                                        </div>
                                        <div class="text-center">
                                            <img :src="avatar1" class="avatar-md rounded-3"
                                                alt="rounded-3">
                                            <p><code>.rounded-3</code></p>
                                        </div>
                                        <div class="text-center">
                                            <img :src="avatar1" class="avatar-md rounded-4"
                                                alt="rounded-4">
                                            <p><code>.rounded-4</code></p>
                                        </div>
                                        <div class="text-center">
                                            <img :src="avatar1" class="avatar-md rounded-5"
                                                alt="rounded-5">
        ...
        <b-row>
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Stacks - Vertical</b-card-title>
                    </b-card-header>
                    <b-card-body>
                        <p class="text-muted mb-3">Use <code>vstack</code> class to create vertical layouts. Stacked items
                            are full-width by default. Use <code>gap-</code> class with variation to add space between
                            items.</p>
                        <div>
                            ...
                            <div class="mt-5">
                                ...
                                <div class="vstack gap-2 col-md-5 mx-auto">
                                    ...
                                    <b-button type="button" variant="outline-secondary">Cancel</b-button>
                                </div>
                            </div>
                        </div>
                    </b-card-body>
                    <b-card-body class="bg-light border-bottom border-top bg-opacity-25">
...
&lt;/div&gt;</code></pre>
            ...
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Stacks - Horizontal</b-card-title>
                    </b-card-header>
                    <b-card-body>
                        ...
                        <div>
                            ...
                            <div class="mt-5">
                                ...
                                <div class="hstack gap-3">
                                    ...
                                    <div class="vr"></div>
                                    <b-button type="button" variant="outline-secondary">Reset</b-button>
                                </div>
                            </div>
                        </div>
                    </b-card-body>
...
&lt;/div&gt;</code></pre>
        ...
        <b-row>
            <b-col xxl="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Object Fit</b-card-title>
                    </b-card-header>

                    <b-card-body>
                        <p class="text-muted mb-3">Use the object fit utilities to modify how the content of a replaced
                            element, such as an <code>&lt;img&gt;</code> or <code>&lt;video&gt;</code>, should be resized to
                            fit its container.</p>

                        <b-row class="g-4">
                            <b-col md="6" cols="lg">
                                <div class="text-center">
                                    <img :src="small3" alt="" height="230" width="200"
...
&lt;img src=&quot;@/assets/images/small/img-3.jpg&quot; alt=&quot;&quot; height=&quot;230&quot; width=&quot;200&quot; class=&quot;rounded object-fit-cover&quot; /&gt;</code>

<code>&lt;img src=&quot;@/assets/images/small/img-3.jpg&quot; alt=&quot;&quot; height=&quot;230&quot; width=&quot;200&quot; class=&quot;rounded object-fit-contain&quot; /&gt;</code>

<code>&lt;img src=&quot;@/assets/images/small/img-3.jpg&quot; alt=&quot;&quot; height=&quot;230&quot; width=&quot;200&quot; class=&quot;rounded object-fit-fill&quot; /&gt;</code>

<code>&lt;img src=&quot;@/assets/images/small/img-3.jpg&quot; alt=&quot;&quot; height=&quot;230&quot; width=&quot;200&quot; class=&quot;rounded object-fit-scale&quot; /&gt;</code>

<code>&lt;img src=&quot;@/assets/images/small/img-3.jpg&quot; alt=&quot;&quot; height=&quot;230&quot; width=&quot;200&quot; class=&quot;rounded object-fit-none&quot; /&gt;</code></pre>
                    </b-card-body>
                </b-card>
            </b-col>
        </b-row>
        ...
        <b-row>
            <b-col xxl="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Z-index</b-card-title>
                    </b-card-header>

                    <b-card-body>
                        <p class="text-muted mb-3">Use our low-level <code>z-index</code> utilities to quickly change the
                            stack level of an element or component.</p>
...
&lt;img src=&quot;@/assets/images/users/avatar-1.jpg&quot; alt=&quot;&quot; class=&quot;avatar-xxl rounded position-relative z-n1&quot; /&gt;</code>

<code>&lt;img src=&quot;@/assets/images/users/avatar-2.jpg&quot; alt=&quot;&quot; class=&quot;avatar-xxl rounded position-relative z-0 ms-n5 mt-5&quot; /&gt;</code>

<code>&lt;img src=&quot;@/assets/images/users/avatar-3.jpg&quot; alt=&quot;&quot; class=&quot;avatar-xxl rounded position-relative z-1 ms-n5&quot; /&gt;</code>

<code>&lt;img src=&quot;@/assets/images/users/avatar-4.jpg&quot; alt=&quot;&quot; class=&quot;avatar-xxl rounded position-relative z-2 ms-n5 mt-5&quot; /&gt;</code>

<code>&lt;img src=&quot;@/assets/images/users/avatar-5.jpg&quot; alt=&quot;&quot; class=&quot;avatar-xxl rounded position-relative z-3 ms-n5&quot; /&gt;</code></pre>
                    </b-card-body>
                </b-card>
            </b-col>
        </b-row>
        ...
        <b-row>
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Text Selection</b-card-title>
                    </b-card-header>
...
<code>&lt;p class=&quot;user-select-none mb-0&quot;&gt;This paragraph will not be selectable when clicked by the user.&lt;/p&gt;</code></pre>
            ...
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Pointer Events</b-card-title>
                    </b-card-header>
                    <b-card-body>
                        <p class="text-muted mb-3">Use <code>pe-none</code> class to prevent and <code>pe-auto</code> class
                            to add element interactions respectively.</p>
                        <div>
                            <p><b-link href="#" class="text-success pe-none" tabindex="-1">This link</b-link> can not be clicked.</p>
                            <p><b-link href="#" class="text-success pe-auto">This link</b-link> can be clicked (this is default
                                behavior).</p>
                            <p class="pe-none mb-0"><b-link href="#" class="text-success" tabindex="-1">This link</b-link> can not be
                                clicked because the <code>pointer-events</code> property is inherited from its parent.
                                However, <b-link href="#" class="pe-auto">this link</b-link> has a <code>pe-auto</code> class and can
                                be clicked.</p>
                        </div>
                    </b-card-body>
                    <b-card-body class="bg-light border-bottom border-top bg-opacity-25">
...
&lt;p&gt;&lt;b-link href=&quot;#&quot; class=&quot;text-success pe-none&quot; tabindex=&quot;-1&quot; aria-disabled=&quot;true&quot;&gt;This link&lt;/b-link&gt; can not be clicked.&lt;/p&gt;</code>

<code>&lt;p&gt;&lt;b-link href=&quot;#&quot; class=&quot;text-success pe-auto&quot;&gt;This link&lt;/b-link&gt; can be clicked (this is default behavior).&lt;/p&gt;</code>

<code>&lt;p class=&quot;pe-none mb-0&quot;&gt;&lt;b-link href=&quot;#&quot; class=&quot;text-success&quot; tabindex=&quot;-1&quot; aria-disabled=&quot;true&quot;&gt;This link&lt;/b-link&gt; can not be clicked because the &lt;code&gt;pointer-events&lt;/code&gt; property is inherited from its parent. However, &lt;b-link href=&quot;#&quot; class=&quot;pe-auto&quot;&gt;this link&lt;/b-link&gt; has a &lt;code&gt;pe-auto&lt;/code&gt; class and can be clicked.&lt;/p&gt;</code></pre>
                    </b-card-body>
                </b-card>
            </b-col>
        </b-row>
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Overflow</b-card-title>
                    </b-card-header>
                    <b-card-body>
...
&lt;/div&gt;</code></pre>
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Position</b-card-title>
                    </b-card-header>
...
&lt;/div&gt;</code></pre>
        ...
        <b-row>
            <b-col lg="12">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Shadows</b-card-title>
                    </b-card-header>
                    ...
                    <b-card-body>
                        <p class="text-muted">While shadows on components are disabled by default in Bootstrap and can be
                            ...
                            three default sizes (which have associated variables to match).
                        </p>
                        <b-row class="gy-3">
                            <b-col md="6">
...
<code>&lt;div class=&quot;shadow-lg p-3 bg-light rounded&quot;&gt;Larger shadow&lt;/div&gt;</code></pre>
        ...
        <b-row>
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Width</b-card-title>
                    </b-card-header>
                    <b-card-body>
...
<code>&lt;div class=&quot;w-auto p-3 bg-light&quot;&gt;Width auto&lt;/div&gt;</code></pre>
            ...
            <b-col xxl="6">
                <b-card no-body>
                    <b-card-header>
                        <b-card-title class="mb-0">Height</b-card-title>
                    </b-card-header>
                    <b-card-body>
