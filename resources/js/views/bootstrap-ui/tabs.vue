...
export default {
    data() {
        return {
            ...
            avatar1, avatar2, avatar3, avatar4, avatar5, avatar6, avatar7, avatar8, small3, small4, small5, small6, small7, small8, 
        };
    },
    components: {
        Layout,
    ...
    <Layout>
            ...
            <b-col xxl="6">
                ...
                <b-card no-body>
                    <b-card-body>
                        ...
                        <b-tabs nav-class="mb-3" justified>
                            <b-tab title="Home">
                                <h6>Graphic Design</h6>
                                <p class="mb-0 text-muted">
                                    They all have something to say beyond the words on the page. They can come across as
                ...
                <b-card no-body>
                    <b-card-body>
                        <p class="text-muted">Use <code>nav-pills</code> class to generate particular selected nav links
                            without borders.</p>
                        <b-tabs nav-class="nav-success mb-3" pills>
                    ...
                    <b-card-body>
                        ...
                        <div class="tab-content text-muted">
                            <div class="tab-pane active" id="home2" role="tabpanel">
                                <p class="flex-grow-1 mb-0"><img :src="avatar2" alt=""
                            ...
                            <div class="tab-pane" id="profile2" role="tabpanel">
                                <p class="me-3 mb-0">
                                    ...
                                    nostrud organic, assumenda labore aesthetic magna delectus.commodo enim craft beer
                                    mlkshk aliquip jean shorts ullamco ad vinyl cillum PBR. Homo nostrud organic, assumenda
                                    labore aesthetic magna delectus Scale all elements of your design: text, elements,
                                    buttons, everything. Increase or decrease the letter spacing depending on the situation
                                    and try, try again until it looks right, and each.
                                </p>
                            </div>
                            <div class="tab-pane" id="messages2" role="tabpanel">
                                <p class="ms-3 mb-0">
                                    ...
                                    cliche high life echo park Austin. Cred vinyl keffiyeh DIY salvia PBR, beer mlkshk
                                    aliquip jean shorts ullamco ad vinyl cillum PBR. Homo nostrud organic, assumenda labore
                                    aes Homo nostrud organic, assumenda labore aesthetic magna delectus Scale all elements
                                    of your design: text, elements, buttons, everything.Increase or decrease the letter
                                    spacing depending on the situation and try, try again until it looks right, and each.
                                </p>
                            </div>
                        </div>
                    </b-card-body>
            ...
            <b-col xxl="6">
                ...
                <b-card no-body>
                    <b-card-body>
                        ...
                        <!-- Nav tabs -->
                        <b-tabs nav-class="nav-tabs-custom nav-success mb-3" justified>
                            <b-tab title="Home" active>
                                <div class="text-muted">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                        ...
                                        <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="mt-2">
                                                <b-link href="#" class="btn btn-sm btn-subtle-primary">Read
                                                    More <i class="ri-arrow-right-line ms-1 align-middle"></i></b-link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <b-col xxl="6">
                ...
                <b-card no-body>
                    <b-card-body>
                        ...
                        <b-tabs nav-class="arrow-navtabs nav-success bg-light mb-3" content-class="text-muted" pills>
                            <b-tab>
                                <template #title>
                                ...
                                <p class="mb-0">
                                    ...
                                    create a
                                    <b-link href="#" class="text-decoration-underline"><b>Fantastic
                                            Design</b></b-link> by using complicated 3D elements. Flat design is your friend.
                            ...
                            <b-tab title="Profile">
                                ...
                                <p class="mb-0">
                                    ...
                                    unusual, and that’s why using contrasting colors in <b-link href="#"
                                        class="text-decoration-underline"><b>Graphic Design</b></b-link> is a must. It’s
                            ...
                            <b-tab>
                                ...
                                <p class="mb-0">
                                    ...
                                    which is excellent news to the beginner and advanced <b-link href="#"
                                        class="text-decoration-underline"><b>Contact Designer</b></b-link>.
                                </p>
                            </b-tab>
                        </b-tabs>
                    </b-card-body>
        ...
        <b-row>
            ...
            <b-col xxl="6">
                ...
                <b-card no-body>
                    <b-card-body class="mb-n4">
                        <p class="text-muted">Use <code>card-footer-tabs</code> class to create the bottom card nav
                            justify
                            tab.</p>

                        <b-tabs nav-class="card-footer-tabs fs-xl" content-class="mb-3"
                            nav-wrapper-class="card-footer bg-transparent border-top" pills justified end>
                            <b-tab active>
                                <template #title>
                                ...
                                <div class="text-muted">
                                    ...
                                    <p class="mb-2">
                                        ...
                                        create
                                        crazy contrast in your design, then a great idea would be for you to use a color
                                        palette
                                        throughout your entire design. It will subconsciously interest viewers and also is
                                        very
                                        pleasing to look at.
                                    </p>
                                    <p class="mb-0">
                                        ...
                                        to
                                        do with them, for the simple fact that it is beautiful to look at.
                                    </p>
                                </div>
                            </b-tab>
                            <b-tab>
                                ...
                                <div class="text-muted">
                                    ...
                                    <p class="mb-2">
                                        ...
                                        the
                                        background in this graphic design is blurred. Whenever you put text on top of an
                                        image,
                            ...
                            <b-tab>
                                ...
                                <div class="text-muted">
                                    ...
                                    <p class="mb-2">
                                        ...
                                        TV
                                        quiz game. Woven silk pyjamas exchanged for blue quartz. Brawny gods just flocked up
                                        to
                                        quiz and vex him.
                                    </p>
                                    <p class="mb-0">
        ...
        <b-row>
            <b-col xxl="6">
                ...
                <b-card no-body>
                    <b-card-body>
                        <p class="text-muted">Use <code>custom-hover-nav-tabs</code> class to create custom hover
                            tabs.</p>
                    </b-card-body>
                    <div class="border">
                        <ul class="nav nav-pills custom-hover-nav-tabs">
                            ...
                            <li class="nav-item">
                                <b-link href="#custom-hover-reviews" data-bs-toggle="tab" aria-expanded="false" class="nav-link">
            ...
            <b-col xxl="6">
                ...
                <b-card no-body>
                    <b-card-body>
                        <p class="text-muted">Use <code>custom-verti-nav-pills</code> class to create custom
                            vertical tabs.
                        </p>
                        <b-row>
                            <b-col lg="3">
                                <div class="nav nav-pills flex-column nav-pills-tab custom-verti-nav-pills text-center"
                                    ...
                                    <b-link class="nav-link active show" id="custom-v-pills-home-tab" data-bs-toggle="pill"
            ...
            <b-col xxl="6">
                ...
                <b-card no-body>
                    <b-card-body>
                        ...
                        <!-- Nav tabs -->
                        <b-tabs nav-class="mb-3" content-class="text-muted" justified>
                            <b-tab title="Explore">
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <i class="ri-checkbox-circle-fill text-success"></i>
        ...
        <b-row>
            <b-col xxl="6">
                ...
                <b-card no-body>
                    <b-card-body>
                        <p class="text-muted">Use <code>nav-border-top</code> class to create nav tabs with border
                            at top.
                        </p>
                        <!-- Nav tabs -->
                            ...
                            <b-tab title="Home">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        ...
                                        Cred vinyl keffiyeh DIY salvia PBR.
                                        <div class="mt-2">
                                            <b-link href="#" class="btn btn-link">Read More <i
            ...
            <b-col xxl="6">
                ...
                <b-card no-body>
                    <b-card-body>
                        <p class="text-muted">*Use <code>nav-custom-</code> class with modifier class to color tabs.
                        </p>
                        <!-- Nav tabs -->
                        <b-tabs nav-class="nav-custom-outline nav-primary mb-3" content-class="text-muted" pills>
                            <b-tab title="Home" active>
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <i class="ri-checkbox-circle-fill text-success"></i>
            ...
            <b-col xxl="6">
                ...
                <b-card no-body>
                    <b-card-body>
                        ...
                        <!-- Nav tabs -->
                        <b-tabs nav-class="nav-custom nav-custom-success mb-3" content-class="text-muted" pills>
                            <b-tab title="Home" active>
